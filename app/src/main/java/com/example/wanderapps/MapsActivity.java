...
import com.example.wanderapps.R;
...
public class MapsActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap.addMarker(new MarkerOptions().position(jogja).title("Marker in Jogja").snippet("Indonesia"));
        float zoom=15;
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        inflater.inflate(R.menu.menu_optional,menu);
        return true;
    }
